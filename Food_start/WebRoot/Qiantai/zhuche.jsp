		...
		<form action="" method="get" id="zc">
			<div>
				...
				<div class="input-group" id="sg">
					...
					</span> <input type="tel" id="inphone" 
						class="form-control" placeholder="输入配送地址"
						aria-describedby="basic-addon1"> <span
						class="glyphicon glyphicon-ok form-control-feedback" id="phone1"></span>
					<span class="glyphicon glyphicon-remove form-control-feedback"
						id="phone2"></span>
					<!--验证-->
				</div>
				...
				<div class="btn-group role=group" role="group">
					<button type="button" class="btn btn-default" onclick="ag()"
						id="cj">立即注册</button>
