	...
	<div class="container">
		...
		<div class="collapse navbar-collapse btn-group">
			<ul class="nav navbar-nav navbar-right" id="navbar-nav">
				<li class="active" id="active"><a href="#">001号桌</a></li>
		...
		<div class="row" id="row">
			<div class="col-md-2 col-sm-2 a " role="group" id="dropdown">
				<ul class="nav " id="left-ul">
					<li><a type="button" class="btn btn-default active">推荐菜</a></li>
					<li><a type="button" href="#" class="btn btn-default">招牌菜</a>
					</li>
					<li><a type="button" href="#" class="btn btn-default">凉菜</a></li>
					<li><a type="button" href="#" class="btn btn-default">热菜</a></li>
					<li><a type="button" href="#" class="btn btn-default">主食</a></li>
					<li><a type="button" href="#" class="btn btn-default">汤锅</a></li>
					<li><a type="button" href="#" class="btn btn-default">酒水</a></li>
					<li><a type="button" href="#" class="btn btn-default">菜单分类</a>
					</li>
				</ul>
			</div>
			<div class="col-md-10 col-sm-6 a">
				<div class="col-md-3  col-sm-6 a">
					<div class="thumbnail">
						<img src="../imags/yucai.jpg" width="250px" height="200px">
						<div class="caption text-center">
							<p id="pone">鱼香肉丝1</p>
							<span id="ptwo">12.8</span>元
							<p class="input-group ">
								<a href="#" class="btn btn-primary input-group-addon jian"
									role="button">-1</a> <input type="text"
									class="form-control numb" value="0" /> <a href="#"
									class="btn btn-default input-group-addon add" role="button">+1</a>
							</p>
						</div>
					</div>
				</div>
